...
class GetNewEpisodeUseCase (private val iChannelRepo: IChannelRepo) : IGetNewEpisodesUseCase {
    override suspend fun getNewEpisodes(): Flow<Resource<List<MediaEntity>>> = iChannelRepo.getNewEpisodes()
}